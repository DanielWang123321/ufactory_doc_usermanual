...
[blockly示例](https://www.ufactory.cc/wp-content/uploads/2025/03/blockly-Bio_Gripper_G2.tar.gz.zip)


### 3.1.3 Modbus RTU控制
进入设置-外接设备-Modbus RTU页面，发送相应的Modbus RTU指令进行控制。  
Modbus通讯协议请参考[Modbus RTU通讯协议控制](4.modbus_rtu_control.md)
...
Modbus通讯协议请参考[UFACTORY私有协议控制](8.appendix-ufactory_private_tcp_protocol_control )

![](assets/biog2_modbusrtu_1.png)
