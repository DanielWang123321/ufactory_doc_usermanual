...
The BIO Mechanical Gripper G2 is a parallel gripper designed for the handling of liquid plates, characterized by quick installation and simple application. The fingers provide excellent gripping power and flexibility.  

The fingers of the BIO Gripper G2 can be freely customized for handling different shapes of tubes and plates.

## 1.1 Work range
BIO Gripper G2 default stroke: 71-150mm.

![](assets/biog2_range.jpg)  

BIO Gripper G2 Finger Reverse Stroke: 4-83mm
