...
Power and communication with the xArm robotic arm is established via a single device cable. The device cable provides 24V power to the Vacuum Gripper and enables IO communication with the robot arm controller. 

Refer to the following diagram for specific pin functions
...
| 12           | No Connect(no use)       |



**Warning:**

Please disconnect the power supply of the robot arm before connecting the Vacuum Gripper and the robot arm.
