...
清除错误步骤：(下面接口具体细节请参考[https://github.com/xArm-Developer/xArm-Python-SDK/blob/master/doc/api/xarm_api.md](https://github.com/xArm-Developer/xArm-Python-SDK/blob/master/doc/api/xarm_api.md))
