...
The robot provides a gigabit Ethernet interface，as shown in the figure below.
![](assets/controller_com.jpg)

**ROBOT PWR** :The Lite6 is powerd on.  
**Motion Status** :The status of Lite6.  
**Network Port** :The Lite6 is communicating normally.  
**USB-C** : Flash the system of Lite6, only for debug internally.


## 3.3 Controller Electrical IO
...
| Configurable Function | CI0-CI7 | Configurable Function     | CO0-CO7 |
| --------------------- | ------- | ------------------------- | ------- |
| General Input         | Yes     | General Output            | Yes     |
| Stop Moving           | Yes     | Motion Stopped            | Yes     |
| Safeguard Reset       | Yes     | Robot Moving              | Yes     |
| Offline Task          | Yes     | Warning                   | Yes     |
| Manual Mode           | Yes     | Collision                 | Yes     |
| Reduced Mode          | Yes     | Manual Mode               | Yes     |
| Enable Robot          | Yes     | Reduced Mode              | Yes     |
|                       |         | Offline Task Running      | Yes     |
|                       |         | Robot Enabled             | Yes     |
|                       |         | Emergency Stop is Pressed | Yes     |
...
#### 3.3.1.1 Connect to Emergency Stop Button
...
#### 3.3.1.2 Share Emergency Stop with other Machines
Digital IO: EI1, EI2, SI0, SI1.   
...
#### 3.3.1.3 Automatically Recoverable Protective Stop
...
#### 3.3.1.4 Protective Stop with Rest Button
...
### 3.3.2 Controller Digital Input&Output(CICO)
#### 3.3.2.1 Controller Digital Input(CI)
...
#### 3.3.2.2 Controller Digital Output(CO)
...
#### 3.3.2.3 Communicate with other Machines or PLCs
...
### 3.3.3 Controller Analog IO(AIAO)
