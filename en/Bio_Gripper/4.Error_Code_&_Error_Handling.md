...
|----------|-------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------|
| BG01 | FOC Run Timeout         | BIO Mechanical Gripper FOC run timeout, please clear the error and retry.                                                                                |
| BG02 | Over Pressure Protection | BIO mechanical gripper over pressure, please contact technical support.                                                                                  |
