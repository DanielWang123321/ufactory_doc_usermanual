...
| Size Parameters: (unit:mm)                           | Joint Coordinate Definition                                   |
|------------------------------------------------------|---------------------------------------------------------------|
| ![](../../assets/850_standard_DH_size_parameter.png) | ![](../../assets/850_standard_joint_coorinate_definition.png) |
...
| Size Parameters: (unit:mm)                    | Joint Coordinate Definition                               |
|-----------------------------------------------|-----------------------------------------------------------|
| ![](../../assets/850_mass_size_parameter.png) | ![](../../assets/850_mass_joint_coorinate_definition.png) |
