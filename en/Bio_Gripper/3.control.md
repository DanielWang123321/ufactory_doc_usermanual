...
**Mode 1:** Position mode. Supports incoming position, force, and speed.
* Position: 71-150
* Velocity: 0-4500
...
1. **Set up BIO Gripper G2**
   ...
   - Select the end effector: xArm BIO Gripper G2

![img_5.png](assets/biog2.png)


### 3.1.1  live control interface control
...
Go to Set-External -Modbus RTU page and send the corresponding Modbus RTU commands for control.

For Modbus communication protocol, please refer to[3.3.2 Read BIO Gripper Register](#332-寄存器地址说明)
...
### 3.3 Use Modbus-RTU Communication Protocol to Control BIO Gripper

#### 3.3.1 Modbus RTU Communication Format
...
| Address | Description                   | Range                                                                              | 单位    | 出厂设定      |
|---------|-------------------------------|------------------------------------------------------------------------------------| ----- |-----------|
| 0x0100  | Enable                        | 0-1；                                                                               |       | 0         |
...
Reception：08 10 07 00 00 02 40 25
```
...
Reception：08 03 04 00 00 00 00 63 33
```
6.  Read Alarm Codes. Address：0x000F
```
Send：08 03 00 0F 00 01 B4 90
Reception：08 03 02 00 00 64 45
```
...
Refer to [3.3.1 Register Address Description](#331-Register Address Description)
...
Reception：00 01 00 02 00 09 7C 50 09 08 06 11 0A 00 00
```
2. Enable the Gripper  Address: 0x0100

```
Send：00 01 00 02 00 0B 7C 09 08 10 01 00 00 01 02 00 01
Reception：00 01 00 02 00 09 7C 50 09 08 10 01 00 00 01
```

3. Open the Gripper

Mode 0 has no position control, sending position > 90,opens the Bio Gripper G2. (OCT)130=(HEX)0082

```
Send：00 01 00 02 00 0d 7C 09 08 10 07 00 00 02 04 00 00 00 82
Reception：00 01 00 02 00 09 7C 50 09 08 10 07 00 00 02
```
